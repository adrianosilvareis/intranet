<?php
if (file_exists(PLUGIN_PATH . "/fast-exames/html/_aux/script.html")) :
    include (PLUGIN_PATH . "/fast-exames/html/_aux/script.html");
endif;
?>
...
<div class="demo-info" style="margin-bottom:10px">
    ...
    <?php
    if (file_exists(PLUGIN_PATH . "/fast-exames/html/_menus/modificar.html")) :
        include (PLUGIN_PATH . "/fast-exames/html/_menus/modificar.html");
    endif;
    ?>
