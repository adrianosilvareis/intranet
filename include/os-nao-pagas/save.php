...
include ("/system/_models/AdminSftInputAten.class.php");
include ("/system/_models/AdminSftInputUnid.class.php");
include ("/system/_models/AdminSftOutputPart.class.php");
...
if (file_exists($filename)):
    ...
    if (!empty($Erros)):
        ...
        header("Location: " . HOME . '/plugin/os-nao-pagas/&save=true');
    endif;
endif;