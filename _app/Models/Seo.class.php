...
class Seo {
    ...
    private function setLib() {
        ...
        $this->seoLibs .= "<script src='" . HOME . "/js/angular/directive/uiTimestampBr.directive.js'></script>" . "\n";
        ...
        $this->seoLibs .= "<script src='" . HOME . "/js/angular/filter/dateBr.filter.js'></script>" . "\n";
        $this->seoLibs .= "<!--CONFIG-->\n";
