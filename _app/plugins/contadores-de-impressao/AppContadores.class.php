...
/**
 * AppContadores.class.php [Beans]
 * 
 * Classe que representa a tabela app_contadores do banco de dados
 * 
 * @copyright (c) 2015, Adriano S. Reis Programador
 */
class AppContadores extends Beans {
    ...
    function __construct() {
        $this->Controle = new Controle('app_contadores');
    }
