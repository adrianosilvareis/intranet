...
/**
 * ImpImpressora.class.php [Beans]
 * 
 * Classe que representa a tabela imp_impressora do banco de dados
 * 
 * @copyright (c) 2015, Adriano S. Reis Programador
 */
class ImpImpressora extends Beans{
    ...
    function __construct() {
        $this->Controle = new Controle('imp_impressora');
    }
