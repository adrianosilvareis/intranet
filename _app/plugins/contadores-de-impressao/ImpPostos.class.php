...
/**
 * ImpPostos.class.php [Beans]
 * 
 * Classe que representa a tabela imp_postos do banco de dados
 * 
 * @copyright (c) 2015, Adriano S. Reis Programador
 */
class ImpPostos extends Beans {
    ...
    function __construct() {
        $this->Controle = new Controle('imp_postos');
    }
