    ...
    <article>
        ...
        <form action = "" method = "post" name = "UserEditForm">
            ...
            <label class="label">
                ...
                <input type="text" name="user_lastname" value="<?= $user_lastname; ?>" title="Informe seu sobrenome" required/>
            </label>

            <label class="label">
                <span class="field">E-mail:</span>
                <input type="email" name="user_email" value="<?= $user_email; ?>" title="Informe seu e-mail" required />
            </label>
            ...
            <div class="label_line">
                <label class="label">
                    ...
                    <input
                        style="width: 260px;" type="password" name="user_password" value="" title="Informe sua senha [ de 6 a 12 caracteres! ]" pattern=".{6,12}" />
                </label>
            </div>
